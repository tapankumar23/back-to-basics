...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.multiagent.grpc.HelloRequest,
      com.example.multiagent.grpc.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.example.multiagent.grpc.HelloRequest.class,
      responseType = com.example.multiagent.grpc.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.multiagent.grpc.HelloRequest,
      com.example.multiagent.grpc.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.example.multiagent.grpc.HelloRequest, com.example.multiagent.grpc.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.example.multiagent.grpc.HelloRequest, com.example.multiagent.grpc.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.multiagent.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.multiagent.grpc.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(com.example.multiagent.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.multiagent.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(com.example.multiagent.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.example.multiagent.grpc.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public com.example.multiagent.grpc.HelloReply sayHello(com.example.multiagent.grpc.HelloRequest request) throws io.grpc.StatusException {
  ...
  public static final class GreeterBlockingStub
    ...
    /**
     */
    public com.example.multiagent.grpc.HelloReply sayHello(com.example.multiagent.grpc.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.multiagent.grpc.HelloReply> sayHello(
        com.example.multiagent.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.example.multiagent.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.example.multiagent.grpc.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.multiagent.grpc.HelloRequest,
              com.example.multiagent.grpc.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.multiagent.grpc.HelloWorldProto.getDescriptor();
    }
